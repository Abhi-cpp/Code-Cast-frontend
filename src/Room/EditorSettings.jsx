...
import { LANGUAGE_OPTIONS, THEME_OPTIONS, FONTFAMILY_OPTIONS, FONTSIZE_OPTIONS } from '../utils/settingsOptions';
...
const Settings = ({
    ...
    return (
        <div className="editor-settings" >
            <h3 className='room-name-id' onClick={() => {
            ...
            <div className="settings-options">
                ...
                <FormControl>
                    <InputLabel id="theme-selector-label" className='option-label'>Theme</InputLabel>
                    <Select
                ...
                <FormControl>
                    <InputLabel id="font-family-selector-label" className='option-label'>Font Family</InputLabel>
                    <Select
